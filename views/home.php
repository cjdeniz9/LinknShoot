...
<html lang="en">
    ...
    ================================================= -->
		<section id="features">
			<div class="container wrapper">
				<h1 style="font-size:1000%;" class="section-title slideDown">LinknShoot</h1></br></br></br>
				...
				<h3 class="sub-title">Network and Socialize with people around the world</h3>
    ...
    ================================================= -->
		<section id="site-facts">
			<div class="container wrapper">
				<div class="circle">
					<h1>LinknShoot Statistics</h1></br>
					<ul class="facts-list">
						<li>
    ...
    ================================================= -->
		<section id="live-feed">
			<div class="container wrapper">
				<h1 class="section-title slideDown">Live Feed</h1></br></br>
