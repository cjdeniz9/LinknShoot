...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    function post_captcha($user_response) {
        $fields_string = '';
        $fields = array(
            'secret' => '6LdVAc8aAAAAAAElpK2ekPJQGElfDWzM4bE8CUxb',
...
<?php } ?>
    ...
    <section>
        <h1>Login Failed</h1>
        <p style="font-size:25px">Incorrect email and/or password. Please try again.</p>
        <a href="?ctlr=admin&amp;action=login" style="font-size:20px">Back</a>
