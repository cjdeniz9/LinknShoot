            ...
            <ul class="nav navbar-nav navbar-right main-menu">
              <li class="dropdown">
                ...
                <ul class="dropdown-menu newsfeed-home">
                  <li><a href="?ctlr=admin&amp;action=home">Home</a></li>
                  <li><a href="?ctlr=admin&amp;action=listProducts&amp;categoryId=1">Account Homepage</a></li>
                </ul>
              </li>
              <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Newsfeed <span><img src="images/down-arrow.png" alt="" /></span></a>
                <ul class="dropdown-menu newsfeed-home">
                  <li><a href="?ctlr=admin&amp;action=addProduct">Add Product</a></li>
              ...
              <li class="dropdown"><a href=".">Log Out</a></li>
            </ul>
    	...
    	<div class="container">
          ...
          ================================================= -->
            ...
            <div class="profile-card">
            	...
            	<h5><a href="timeline.html" class="text-white">My Account</a></h5>
