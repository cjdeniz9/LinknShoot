...
<html lang="en">
    ...
    <section>
        ...
        <p style="font-size:25px">Please correct the following errors to sign up:</p>
        <p style="font-size:22px"><?php echo $vm->errorMsg; ?></p>

        <a href="?ctlr=admin&amp;action=register" style="font-size:20px">Back</a>
